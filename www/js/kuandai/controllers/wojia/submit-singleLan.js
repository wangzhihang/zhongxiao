appControllers.controller('kuandai-cbss-submit-singleLan', function($scope, $state, $rootScope, $http, $ionicPopup, $timeout, unicomm_server, ble) {
	...
	$scope.uc = {};
	// 单宽 || 融合
	$scope.uc.cmd = "cbss_lan_submitSingleLan";
	$scope.uc.baseinfo = {
