appControllers.controller('unicom-order', function($scope, $filter, my, $http, $state, $ionicPopup, $ionicLoading, $rootScope) {
    $scope.title = '联通商城订单';
    $scope.orderList = [];
    // $rootScope = loginInfo;
    $scope.userId = '';
    ...
    $scope.stateList = [{ "name": "未处理", "num": "0", "status": "000001" }, { "name": "已派单", "num": "1", "status": "000003" },
        { "name": "受理中", "num": "2", "status": "000007" }, { "name": "装机成功", "num": "3", "status": "000004" }, { "name": "已退单", "num": "4", "status": "000005" }, { "name": "用户取消", "num": "5", "status": "000006" }
    ];
    ...
    $scope.colorList = [{
            ...
            "failColor": false,
            "cancelColor": false,
            "signatureColor": false,
            "dealColor": true,
            "isNoShowStateChange": true,
            "isNoShowUnicomMallBot": true,
            "isNoShowReminser": false,
            "stateVal": "派单",
            "assignVal": "退单"
        },
        {
